    ...
    <aside class="sidebar">
        <div class="sidebar-inner">
            ...
            <nav class="sidebar-nav">
                ...
                <a href="/dashboard/coherence.php" class="sidebar-link active" data-index="6" data-locked="true">
...
<div id="lockedOverlay">
    <div class="locked-card">
        ...
        <a href="/dashboard/pipeline.php" class="go-pipeline-btn">Go to Pipeline</a>
    </div>
</div>
