...
<div class="dashboard-container">
    ...
    <aside class="sidebar">
        ...
        <nav class="menu">
            ...
            <a href="/pulsekit/dashboard/c2g.php" class="active" data-locked="true">C2G Growth Drivers</a>
    ...
    <main class="content">
        <div class="page-header">
            ...
            <p>"Who moved the needle?" — Additive contribution to trend-true growth</p>
        </div>
        ...
        <div class="filter-container">
            <div class="filter-group">
                ...
                <select onchange="changeDrillBy(this.value)">
                    <option value="regions" <?php echo $drill_by === 'regions' ? 'selected' : ''; ?>>Regions</option>
                    <option value="clusters" <?php echo $drill_by === 'clusters' ? 'selected' : ''; ?>>Clusters</option>
                    <option value="products" <?php echo $drill_by === 'products' ? 'selected' : ''; ?>>Products (Brands)</option>
                </select>
            </div>
        </div>
        ...
        <div class="chart-container">
            <h3 class="chart-title">📊 Top 10 Contributors to Growth</h3>
        ...
        <div class="table-container">
            <h3 class="table-title">Detailed Breakdown - <?php echo $drill_title; ?></h3>
            <table>
                <thead>
                    <tr>
                        <th>Rank</th>
        ...
        <div class="grid-2">
            <div class="chart-container">
                <h3 class="chart-title">📈 Growth Drivers Summary</h3>
                <table>
                    <tbody>
                        <tr>
            ...
            <div class="chart-container">
                <h3 class="chart-title">📊 Contribution Distribution</h3>
                <table>
                    <tbody>
                        <tr>
